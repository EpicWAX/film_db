...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 30 nov. 2017 à 13:12
...
CREATE TABLE IF NOT EXISTS `acteurs` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_Acteurs_id_Film` (`id_Film`)
...
(53, 'Kevin', 'Costner', 'USA', 2),
(54, 'Mary', 'McDonnell', 'USA', 2),
(55, 'Kevin', 'Costner', 'USA', 2),
(56, 'Mary', 'McDonnell', 'USA', 2),
(57, 'Rodney A.', 'Grant', 'USA', 2),
(58, 'Tom', 'Hanks', 'USA', 3),
(59, 'Rodney A.', 'Grant', 'USA', 2),
(60, 'Tom', 'Hanks', 'USA', 3),
(61, 'Michael Clarke', 'Duncan', 'USA', 3),
(62, 'David', 'Morse', 'USA', 3),
(63, 'Michael Clarke', 'Duncan', 'USA', 3),
(64, 'David', 'Morse', 'USA', 3);
